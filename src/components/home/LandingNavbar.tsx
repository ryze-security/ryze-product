			...
			<div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center text-white">
				...
				<div className="font-roboto">
					{loggedIn ? (
						...
						<Link to="/login">
							<Button variant="ghost" className="hover:font-bold hover:scale-110 font-roboto text-white hover:shadow-[0_0_15px_3px_rgba(255,255,255,0.4)] hover:bg-white/10">
								Login
							</Button>
						</Link>
					)}
