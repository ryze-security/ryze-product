...
function Home() {
	...
	return (
		<div className="font-roboto text-white w-full min-h-screen overflow-x-hidden">
			...
			<span className="min-h-screen block">
				{/* Hero Section */}
				<FadeInSection>
				...
				{/* Subtext + Button */}
				<FadeInSection>
					<section className="w-full text-center mt-12 px-4">
						<p className="text-lg md:text-4xl font-bold max-w-4xl mx-auto mb-6 leading-snug">
							Transforming security reviews
							<br />
							<span className="bg-[linear-gradient(to_right,#7030A0,#DA3D49,#EB7135,#1AC7F7,#EB7135,#DA3D49,#7030A0)] bg-clip-text text-transparent animate-gradient">
			...
			{/* Arrow Down Button */}
			{false && (
				<div className="w-full flex justify-center mt-16 animate-bounce relative">
				...
				>
					<div className="max-w-5xl mx-auto">
						...
						<p className="text-lg sm:text-xl leading-relaxed text-zinc-300">
							Ryzr is redefining the security review process with
							a focus on speed, accuracy, and developer
							experience. Our platform streamlines assessments,
							cuts down delays, and helps teams ship secure code
							faster than ever.
						</p>
						<p className="text-md sm:text-lg mt-6 text-zinc-400">
							Backed by cutting-edge AI and built for modern
							security teams, Ryzr is designed to adapt to your
